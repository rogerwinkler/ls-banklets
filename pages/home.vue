<template>
  <div class="content">
    ...
    <v-btn
      ...
      large
      rounded
      @click="$router.push('card-admin')"
      elevation="6"
    >
      <v-icon left> mdi-credit-card-multiple-outline </v-icon
      >{{ $t("card-admin") }}</v-btn
    >
    <v-btn
      color="primary"
